      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            <span className="gradient-text">Video Detection</span>
          </h1>
          <p className="text-gray-400 text-lg">
            Upload a video to detect if it contains deepfake or AI-generated content
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          className="glass rounded-xl p-4 mb-8 border border-cyan-400/30"
        >
          <p className="text-sm text-cyan-400">
            💡 Tip: For optimal results, upload videos shorter than 2 minutes. The AI will analyze multiple frames to detect inconsistencies.
          </p>
        </motion.div>
